      ...
      <div class="checkout-tit">
        ...
        <div class="paymark">
          ...
          <span class="fr">
            ...
            <em class="orange money">￥{{ orderDetails.totalFee }}</em>
          </span>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    async open() {
      //生成二维码
      let url = await QRCode.toDataURL(this.orderDetails.codeUrl);
  ...
  computed: {
    ...
    //获取订单信息
    orderDetails() {
      return this.$store.state.trade.orderDetails
    }

  },
  mounted() {
    this.$store.dispatch('OrderInformation', this.orderId);
  },
}
</script>
